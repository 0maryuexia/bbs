...
<div id="jive-forumpage">
    ...
    <div class="jive-buttons">
        <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="jive-icon"><a href="/jsp/hosp.jsp"><img src="../images/post-16x16.gif" alt="发表新主题" border="0" height="16" width="16"></a></td>
                ...
                <td class="jive-icon"><a href="/jsp/article.jsp"><img src="../images/search-16x16.gif" alt="发表新主题" border="0" height="16" width="16"></a></td>
                <td><a href="/jsp/article.jsp">树状结构展现</a></td>
            </tr>
            </tbody>
        </table>
    </div>
                    ...
                    <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <%
                            ...
                            for (Iterator<Article> it = articles.iterator(); it.hasNext();){
                                Article a = it.next();
                                String  strk  = k % 2 == 0 ? "jive-even":"jive-odd";
                        %>
                        <tr class="<%= strk%>">
                            ...
                            <td nowrap="nowrap" width="1%">&nbsp;
                                ...
                                &nbsp;</td>
                            <td class="jive-thread-name" width="95%"><a id="jive-thread-1" href="/jsp/article_detail_Flat.jsp?id=<%= a.getId() %>"><%= a.getTitle() %></a></td>
